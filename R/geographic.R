#' Get country
#'
#' @description function which gets a list of all countries available in the AClimate platform.
#'
...
#'
#' @description function which gets a list of all weather stations available in the AClimate platform.
#'
#' @param url_root Url root where the API is located.
...
#'
#' @export
get_ws = function(url_root, country_id){   
    library(httr)
    library(rjson)
    httr::set_config(config(ssl_verifypeer = 0L))     
    # Downloading data
