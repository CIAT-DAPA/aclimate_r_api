...
Browse its [source code](https://github.com/CIAT-DAO/aclimate_rapi/).
...
The easiest way to install the package is from [Github repository](https://github.com/CIAT-DAPA/aclimate_rapi/) and using devtools.

```{r}
devtools::install_github("CIAT-DAPA/aclimate_rapi")
```
...
setwd("D:/CIAT/Code/USAID/aclimate_rapi")
library(devtools)
```